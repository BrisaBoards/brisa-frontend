<template>
  <div style="display: inline;">
    <slot></slot>
    <div @click="SelectLabel(idx)" :class="'badge ' + (selected == idx ? hlight : 'text-light')"
        :style="'z-index: 0; overflow: hidden; position: relative; display: inline-block; font-size: 100%; font-weight: bold; border-radius: 5px; cursor: pointer; padding: 7px;' + add_style"
